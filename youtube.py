...
def channels_table(channel_name_s):
    ...
    # Fetching all data from channels table
    ...
    print("DataFrame columns:", df_all_channels.columns)

    if df_all_channels.empty:
        print("DataFrame is empty!")
    else:
        print("First column:", df_all_channels.iloc[:, 0])

    # Check if the DataFrame has any columns
    if not df_all_channels.empty and df_all_channels.shape[1] > 0:
        # Append the first column to chann_list
        chann_list = []
        chann_list.append(df_all_channels.iloc[:, 0])

        # Convert first column to list
        chann_list2 = chann_list[0].tolist()
...
def comments_table(channel_name_s):
    ...
    for index, row in df_single_channel.iterrows():
        ...
        try:
            ...
            print("Error inserting comment values:", e)
